...
func Sender(signer Signer, tx *Transaction) (common.Address, error) {
	...
	// @anson
	// 从本次数字签名的签名字符串中恢复出公钥，并转化为tx的转出方地址
...
// @anson
// Ethereum中的数字签名计算过程中所产生的signature是一个长度为65bytes的字节数组，它被截成三段放入tx中
// 前32bytes给成员变量R，再32bytes赋值给S，末1byte赋值给V
// 上述赋值过程存在[]byte -> *big.Int的类型转换
