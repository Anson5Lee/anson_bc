...
import (
	...
	"github.com/Anson5Lee/anson_bc/rpc"
...
func (s *PrivateAccountAPI) ImportRawKey(privkey string, password string) (common.Address, error) {
	...
	sk1, err := crypto.ToECDSA(hexkey)
	if err != nil {
		return common.Address{}, err
	}
	sk2, err := crypto.ToECDSA(hexkey)
	if err != nil {
		return common.Address{}, err
	}
...
//
// https://github.com/Anson5Lee/anson_bc/wiki/Management-APIs#personal_sign
...
//
// https://github.com/Anson5Lee/anson_bc/wiki/Management-APIs#personal_ecRecover
...
// @anson
func (s *PublicTransactionPoolAPI) GetOTAMixSet(ctx context.Context, otaHex string, l int) ([]string, error) {
	ota := common.FromHex(otaHex)
	...
	otaByteSet, err := state.GetOTASet(ota, l)
	if err != nil {
		return nil, err
	}
	ret := make([]string, 0)
...
func (s *PublicTransactionPoolAPI) GenerateOneTimeAddress(ctx context.Context, waddr string) (string, error) {
	...
	// fmt.Printf("%v", SKOTA) output with "Ox" prefix
